...
У меня не все компоненты есть (например, модуль CAN-шины отсутствует),
поэтому практическую реализацию не смог проверить и не утверждаю, что в реальности все будет работать "ок"
...
| P3 | выбор чипа | выход | → CS модуля MCP2515 |
